...
public class Main {
    ...
    public void test_trade_pay(AlipayTradeService service) {
        ...
        String providerId = "C:\\Users\\LSY66\\Desktop\\电子商城";
    ...
    // 测试当面付2.0生成支付二维码
    public void test_trade_precreate(String total) {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        ...
        String subject = "桂电品牌xxx门店当面付扫码消费";
        ...
        // 业务扩展参数，目前可添加由支付宝分配的系统商编号(通过setSysServiceProviderId方法)，详情请咨询支付宝技术支持
        ExtendParams extendParams = new ExtendParams();
        extendParams.setSysServiceProviderId("2088621955658870");
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("C://Users//LSY66/Desktop/电子商城/qr-%s.png",
                    response.getOutTradeNo());
                ZxingUtils.getQRCodeImge(response.getQrCode(), 400, filePath);
